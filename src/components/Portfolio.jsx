  ...
  return (
    <div name="Portfolio" className="max-w-screen-2xl container mx-auto px-4 md:px-20 mt-10">
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-5 p-3 my-5 h-auto'>
        {
          cardItems.map(({id,logo,name,sourCode,demo})=>(
            ...
            <div className='px-6 py-4 space-x-3 justify-around'>
              <button className='w-20 h-10 bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded'><a href={demo} target='_blank'>Demo</a></button>
              <button className='w-30 h-10 bg-green-500 hover:bg-green-700 text-white font-bold px-4 py-2 rounded'><a href={sourCode} target='_blank'>Source Code</a></button>
            </div>
            </div>
